...
#define WEATHER_TEMP_MAX_LEN    8
#define WEATHER_TEXT_MAX_LEN    32
#define WEATHER_ICON_MAX_LEN    8

extern char weather_temp[WEATHER_TEMP_MAX_LEN];
extern char weather_text[WEATHER_TEXT_MAX_LEN];
extern char weather_icon[WEATHER_ICON_MAX_LEN];
typedef enum {
